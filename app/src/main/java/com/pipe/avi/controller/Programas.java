...
public class Programas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // ADAPTER CORREGIDO PARA ABRIR AR
        adapter = new ProgramaAdapter(new ArrayList<>(), programa -> {

            String urlAR = programa.getAr();

            if (urlAR == null || urlAR.isEmpty()) {
                Toast.makeText(Programas.this, "Este programa no tiene experiencia AR.", Toast.LENGTH_SHORT).show();
                return;
            }
    ...
    private void setupSpinner() {
        ...
        ArrayAdapter<String> spinnerAdapter =
                new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, niveles);
